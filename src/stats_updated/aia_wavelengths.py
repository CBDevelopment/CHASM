...
if __name__=="__main__":
    ...
    for year in years:
        ...
        num_per_wavelength = [len(os.listdir(folder)) for folder in wavelength_folders]

        print(f"Year: {year}, Mean: {np.mean(num_per_wavelength)}, Standard Deviation: {np.std(num_per_wavelength)}")
