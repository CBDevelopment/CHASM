...
from sunpy.map import Map, all_coordinates_from_map # TODO figure out if this only works for bool, that could be problem
...
def convertMapInference(grouped_files, converted_path, resolution, n_workers=8, replace=False):
