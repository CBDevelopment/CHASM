...
from src.polished_pipeline.train_model import (
    train_models_swpc,
    preprocess_chronnos,
    remove_unmatched_files_recursive,
)
...
def download_data(path="data", includes="all") -> None:
    ...
    if includes == "all":
        includes = [
            ...
            "masks",
            "aia",
        ]  # TODO add AIA after getting that uploaded to Google Drive
...
def train_chronnos_model(
    base_path: str | CombinedDataset, convert: bool = True
) -> None:
    """
...
if __name__ == "__main__":
    ...
    preprocess_chronnos(
        r"C:\Users\evang\Desktop\WPI\Coronal Holes ISP\CoronalHoles\data_test_set_5",
